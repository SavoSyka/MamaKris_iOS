...
- Внизу у вас есть панель, которая состоит из следующих разделов:\n\n'''),
        ...
        const TextSpan(text: '(в профиле указана почта с которой Вы вошли в аккаунт и есть возможность выхода из аккаунта, смены пароля и удаления аккаунта)\n'),
        ...
        const TextSpan(text: 'С уважением, команда приложения MamaKris.\n'),
